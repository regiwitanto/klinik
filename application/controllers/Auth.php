  ...
  private function _login()
  {
    ...
    if ($user) {
      if ($user['is_active'] == 1) {
        ...
        $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Username ini belum diaktivasi!</div>');
        redirect('auth');
      }
    } else {
      $this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Username ini belum terdaftar!</div>');
      redirect('auth');
    }
  }
